...
if __name__ == '__main__':
    ...
    Input.img = average_pooling(Input.img, *Input.shape)

    # imsave
    plt.imsave('./ImgOut/2-7_Average Pooling.JPG', Input.img)