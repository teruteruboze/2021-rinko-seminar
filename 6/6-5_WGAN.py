...
import util.trainWDCGAN as train
...
if __name__ == '__main__':
    ...
    modelDis   = makeNet.WassersteinDCDiscriminator(config['training']['nCH'], 
                                                    config['training']['nFEATURE'],
                                                    config['training']['nGPU']).to(device)
    ...
    for epoch in range(config['training']['EPOCH']):
        ...
        # Train
        LossG, LossD = train.do(config, logger, dataset.train, modelGen, modelDis, optimizerGen, optimizerDis, device)
